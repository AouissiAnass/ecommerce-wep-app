...
<body>
    ...
    <div class="row">
        ...
        <div class="col">
            <a href="CREATE_PRODUCT.php"><button type="button" class="btn btn-success main-add-button">
                    Add Key
                </button>
            </a>
            <table id="myTable" class="table my-table">
                ...
                <tbody id="tablebody">
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<td><a class="btn btn-primary blue-btn" href ="UPDATE_PRODUCT.php?id=' . $row["id"] . '" role = "button">UPDATE</a><a class="btn btn-primary" href ="DELETE_PRODUCT.php?id=' . $row["id"] . '" role = "button">DELETE</a></td>';
                        echo "</tr>";
                    }
                    ?>
                </tbody>
