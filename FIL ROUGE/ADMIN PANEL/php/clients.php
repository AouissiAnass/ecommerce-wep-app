            ...
            <table id="myTable" class="table my-table">
                ...
                <tbody id="tablebody">
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<td><a class="btn btn-primary blue-btn" href ="UPDATE_CLIENT.php?id=' . $row["id"] . '" role = "button">UPDATE</a><a class="btn btn-primary" href ="DELETE_CLIENT.php?id=' . $row["id"] . '" role = "button">DELETE</a></td>';
                        echo "</tr>";
                    }
                    ?>
                </tbody>
